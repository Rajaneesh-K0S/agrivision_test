...
const { registerUser, login, resendMail, googleOauth, googleOneTapLogin, confirmEmail, resetPassword, forgotPassword, getCart, deleteProductInCart, addToCart, getReminder, userProgress, addReminder, getProfile, updateProfile} = require('../controllers/userController');
